...
<html lang="en" class="no-js">
	<head>
		...
		<title>Smart Parking| Slot Reservation </title>
		<meta name="description" content="An experimental demo where a 3D perspective preview is shown for a selected slot in a parking area." />
		<meta name="keywords" content="parking, slot booking, parking plan, perspective, 3d" />
		<meta name="author" />
	...
	<body>
		<header class="header">
			...
			<h1 class="header__title">Parking Slot Reservation</h1>
						...
						<div class="intro intro--shown">
							<div class="intro__side">
								<h2 class="intro__title">
									<span class="intro__up"><em></em></span>
									<span class="intro__down">Smart Parking </span>
								</h2>
							</div>
							<div class="intro__side">
								<button class="action action--seats">Select your parking slot</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="plan">
			<h3 class="plan__title">Parking Area Layout</h3>
			...
			<a href="Semproject/project.html" class="action action--buy">Pay for the slot</button>
				<a href="../project.php" class="action action--buy">Back</button>
		</div><!-- /plan -->
