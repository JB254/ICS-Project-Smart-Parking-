<?php 
	...
	// connect to database
	$db = mysqli_connect('localhost', 'root', '', 'semproject');
...
function space(){
    ...
    global $db, $errors, $location_id, $entry_date, $entry_time, $exit_date, $exit_time;
    ...
    if (count($errors) == 0) {
        ...
        if (isset($_POST['location_id'])) {
            ...
            $query = "INSERT INTO reserve (location_id, entry_date, entry_time, exit_date, exit_time)
                      VALUES('$location_id', '$entry_date', '$entry_time', '$exit_date', '$exit_time')";
